...
describe('RegistryLoader', () => {
    ...
    beforeEach(() => {
        registryLoader = new registry_loader_1.RegistryLoader(mockRegistryPath);
        jest.clearAllMocks();
    ...
    describe('loadRegistry', () => {
        ...
        it('should throw CLIError for invalid JSON', async () => {
            ...
            await expect(registryLoader.loadRegistry()).rejects.toThrow(types_1.CLIError);
...
//# sourceMappingURL=registry-loader.test.js.map