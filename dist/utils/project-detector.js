...
class ProjectDetector {
     ...
     */
    detectProjectType(packageJson, projectRoot) {
        const dependencies = {
     ...
     */
    detectTypeScript(packageJson, projectRoot) {
        const dependencies = {
            ...packageJson.dependencies,
            ...packageJson.devDependencies
        };
     ...
     */
    detectTailwind(packageJson, projectRoot) {
        const dependencies = {
            ...packageJson.dependencies,
            ...packageJson.devDependencies
        };
     ...
     */
    hasConfigFile(projectRoot, filenames) {
        return filenames.some(filename => fs.existsSync(path.join(projectRoot, filename)));
    }
    /**
     * Creates a default project configuration based on detection results
     */
    createDefaultConfig(detection) {
        const baseConfig = {
