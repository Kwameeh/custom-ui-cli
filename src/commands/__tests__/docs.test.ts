...
describe('DocsCommand', () => {
  ...
  const mockComponent = {
    metadata: {
      ...
      dependencies: ['utils'],
      files: [
        { path: 'components/ui/button.tsx', content: 'interface ButtonProps { variant?: string; }', type: 'component' as const },
  ...
  describe('showComponentDocs', () => {
    it('should display text documentation by default', async () => {
      ...
      await (docsCommand as any).showComponentDocs('button', {});
    ...
    it('should display JSON documentation when requested', async () => {
      ...
      await (docsCommand as any).showComponentDocs('button', { format: 'json' });
    ...
    it('should show examples when available', async () => {
      ...
      await (docsCommand as any).showComponentDocs('button', { examples: true });
  ...
  describe('showGeneralHelp', () => {
    it('should show usage instructions', async () => {
      ...
      await (docsCommand as any).showGeneralHelp();
  ...
  describe('displayTextDocs', () => {
    it('should display complete component information', () => {
      (docsCommand as any).displayTextDocs('button', mockComponent, {});
    ...
    it('should handle components without dependencies', () => {
      ...
      (docsCommand as any).displayTextDocs('button', componentWithoutDeps, {});
  ...
  describe('displayJsonDocs', () => {
    it('should output valid JSON', () => {
      (docsCommand as any).displayJsonDocs('button', mockComponent);
  ...
  describe('displayExamples', () => {
    it('should display provided examples', () => {
      (docsCommand as any).displayExamples('button', mockComponent);
    ...
    it('should generate basic example when none provided', () => {
      ...
      (docsCommand as any).displayExamples('button', componentWithoutExamples);
  ...
  describe('extractPropsInterface', () => {
    it('should extract interface definitions', () => {
      ...
      const result = (docsCommand as any).extractPropsInterface(content);
  ...
  describe('generateBasicExample', () => {
    it('should generate button example', () => {
      const example = (docsCommand as any).generateBasicExample('button');
    ...
    it('should generate input example', () => {
      const example = (docsCommand as any).generateBasicExample('input');
    ...
    it('should generate card example', () => {
      const example = (docsCommand as any).generateBasicExample('card');
    ...
    it('should generate generic example for unknown components', () => {
      const example = (docsCommand as any).generateBasicExample('unknown');
  ...
  describe('parseOptions', () => {
    it('should parse format option', () => {
      const options = (docsCommand as any).parseOptions(['--format', 'json']);

      expect(options.format).toBe('json');
    });

    it('should parse examples flag', () => {
      const options = (docsCommand as any).parseOptions(['--examples']);

      expect(options.examples).toBe(true);
    });

    it('should handle multiple options', () => {
      const options = (docsCommand as any).parseOptions(['--format', 'text', '--examples']);
    ...
    it('should validate format option', () => {
      const options = (docsCommand as any).parseOptions(['--format', 'invalid']);
  ...
  describe('extractComponentNames', () => {
    it('should extract component names from arguments', () => {
      const names = (docsCommand as any).extractComponentNames(['button', 'input']);

      expect(names).toEqual(['button', 'input']);
    });

    it('should ignore option flags', () => {
      const names = (docsCommand as any).extractComponentNames(['button', '--format', 'json', 'input']);

      expect(names).toEqual(['button', 'input']);
    });

    it('should handle empty arguments', () => {
      const names = (docsCommand as any).extractComponentNames([]);

      expect(names).toEqual([]);
    });

    it('should handle only options', () => {
      const names = (docsCommand as any).extractComponentNames(['--format', 'json', '--examples']);
  ...
  describe('getAvailableComponentNames', () => {
    it('should return sorted component names', async () => {
      ...
      const names = await (docsCommand as any).getAvailableComponentNames();
